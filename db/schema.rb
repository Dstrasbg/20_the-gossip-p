...
ActiveRecord::Schema.define(version: 2019_10_28_200408) do
  ...
  create_table "gossip_comm_comms", force: :cascade do |t|
    t.bigint "gossip_id"
    t.bigint "tag_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["gossip_id"], name: "index_gossip_comm_comms_on_gossip_id"
    t.index ["tag_id"], name: "index_gossip_comm_comms_on_tag_id"
  end
